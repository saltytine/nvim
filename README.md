...
- [4. Plugins \& LSP](#5-plugins--lsp)
  - [4.1. Plugins](#51-plugins)
  - [4.2. LSP](#52-lsp)
- [5. Keymaps](#6-keymaps)
- [6. Customization](#7-customization)
- [7. Contribution](#8-contribution)
- [8. Guide and resources](#9-guide-and-resources)
...
| `<leader>`+<kbd>h/u/j/k</kbd>  | Normal | Move around splits                            |
| <kbd>mm</kbd>                  | Normal | Comment/Uncomment line                        |

and more that i'm too lazy to list, check mappings.lua
